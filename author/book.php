          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-lg-10">
                ...
                <a href="sample_question.php">Help Post</a>
    ...
    <?php
        ...
        ?>
            ...
            <?php
                ...
                echo "<thead><th>Book ID</th> <th>Book Title</th> <th>Department</th> <th>Image Link</th><th>PDF Link</th> <th>Option</th> <th>Update</th></thead> \n";
